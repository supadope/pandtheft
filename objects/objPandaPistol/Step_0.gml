...
if keyboard_check_pressed(ord("W")) {sprite_index = sprPandaPistolIUp;}
if keyboard_check_pressed(ord("S")) {sprite_index = sprPandaPistolIDown;}
if keyboard_check_pressed(ord("D")) {sprite_index = sprPandaPistolIRight;}
